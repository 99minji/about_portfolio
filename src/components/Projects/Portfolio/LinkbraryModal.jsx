...
const LinkbraryModal = () => {
  return (
    <div className="modal-contents">
      ...
      <p className="info">
        - 링크 수정 및 삭제 시 실시간 업데이트를 위해 <strong>Zustand</strong>를
        사용하여 상태 업데이트가 간편하고 빠르게 반영되도록 구현했습니다.
        <br />- CSS Grid와 Flexbox 활용으로 뷰 전환 로직을 단순화하여 코드량을
        줄였습니다.
        <br />- 즐겨찾기 목록 페이지에서는 사용자 인증을 서버에서 검증하고 최신
        데이터를 SSR을 통해 미리 가져와 렌더링하여 초기 로딩 속도를
        개선했습니다.
      </p>
